...
contract PoolManipulation is IERC721Receiver {
    address public constant SYT;
    ...
    function mintNewPosition(uint256 amt0, uint256 amt1)
        external
        returns (
            uint256 tokenId,
            uint128 liquidity,
        ...
        )
    {
        ...
        uint256 amount0ToMint = amt0;
        uint256 amount1ToMint = amt1;
